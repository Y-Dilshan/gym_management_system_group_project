...
export default function AdminDashboard() {
  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen text-white">
      {/* Fixed Sidebar */}
      <aside className="fixed left-0 top-0 w-[280px] h-screen bg-[#050505] border-r border-[#2A2A2A] pl-6 pt-6 pr-6 flex flex-col justify-between">
        <div>
          {/* Logo */}
          <div className="mb-8 flex gap-3 items-center">
            <img src="/logo.png" alt="logo" className="w-[60px] h-[60px] object-contain" />
            <div className="flex flex-col">
              <h1 className="text-[#D4AF37] text-lg font-bold leading-none">POWER ZONE</h1>
          ...
          <div className="space-y-4 overflow-y-auto max-h-[70vh] pr-2">
            <div>
              ...
              <NavLink to="/admin" className="flex items-center gap-3 p-3 rounded-xl transition-all duration-300 text-white hover:bg-[#1A1A1A]" style={({ isActive }) => isActive && isDashboard ? { backgroundColor: "#D4AF37", color: "black", fontWeight: "bold" } : {}}>
          ...
          <>
            ...
            <div className="bg-gradient-to-r from-[#111111] to-[#1C1C1C] border border-[#D4AF37]/20 rounded-2xl shadow-xl p-6 mb-8 flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-400 mt-2">Manage your gym system efficiently with real-time stats</p>
              </div>
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {orders.slice(0, 5).map((order) => (
                      <tr key={order.order_id} className="border-b border-[#2A2A2A] hover:bg-[#1C1C1C]">
                        <td className="px-6 py-5 text-white">#ORD{order.order_id}</td>
                        <td className="px-6 py-5 text-gray-300">{order.customer_name}</td>

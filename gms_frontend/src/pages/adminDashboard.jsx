    ...
    return(
        <div className="w-full h-full flex items-center justify-center">
            <div className = "w-[20%] h-screen bg-[#333333] flex flex-col items-center justify-start py-10">
                ...
                <h2 className = "flex text-[#D4AF37] text-4xl text-bold">Admin Dashboard</h2>
                <ul>
                    ...
                    <li className="mb-2 text-3xl pt-[20px]"><Link to="/admin/orders" className="text-white hover:text-4xl flex gap-2"><LiaThListSolid /> Orders</Link></li>
                    <li className="mb-2 text-3xl pt-[20px]"><Link to="/admin/payments" className="text-white hover:text-4xl flex gap-2"><MdPayments />Payments</Link></li>
                </ul>
            </div>

...
export default function ApplyAsTrainer() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1E1E1E] via-[#252525] to-[#1E1E1E] text-white">
      {/* Golden Glow */}
      ...
      <section className="relative py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="w-28 h-1 bg-[#D4AF37] mx-auto mt-6 rounded-full"></div>
      ...
      <section className="relative pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Success */}
          {status === "success" && (
            <div className="mb-8 bg-green-500/10 border border-green-500/30 rounded-xl p-5">
          ...
          <div className="flex justify-center gap-3 mt-10">
            ...
            <div className="w-3 h-3 rounded-full bg-[#D4AF37] opacity-60" />
            <div className="w-3 h-3 rounded-full bg-[#D4AF37] opacity-30" />
          </div>
        </div>
      </section>
    </div>

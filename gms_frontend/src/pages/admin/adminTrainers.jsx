      ...
      <div className="bg-[#141414] border border-[#D4AF37]/20 rounded-3xl overflow-hidden shadow-[0_0_30px_rgba(212,175,55,0.08)]">
        ...
        <div className="flex justify-between items-center px-8 py-6 border-b border-[#2A2A2A]">
          ...
          <div className="flex gap-4">
            ...
            <Link to= "/admin/add-trainers" className="bg-[#D4AF37] text-black px-5 py-2 rounded-xl font-semibold hover:scale-105 transition duration-300">
              + Add Trainer
            </Link>
          </div>
            ...
            <tbody>
              ...
              <tr className="border-b border-[#2A2A2A] text-gray-300 hover:bg-[#1C1C1C] transition-all duration-300">
                ...
                <td className="px-6 py-5">
                  <img
                    src="https://images.unsplash.com/photo-1567013127542-490d757e51fc?w=500"
                    alt="Trainer"
                ...
                <td className="px-6 py-5">
                  <div className="flex gap-3">
                    ...
                    <button className="bg-blue-600 px-5 py-2 rounded-xl text-white font-semibold hover:bg-blue-700 hover:scale-105 transition duration-300">
                      Edit
                    </button>

                    <button className="bg-red-600 px-5 py-2 rounded-xl text-white font-semibold hover:bg-red-700 hover:scale-105 transition duration-300">
                      Delete
                    </button>

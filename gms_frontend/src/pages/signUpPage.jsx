  ...
  return (
    <div className = "flex">
        ...
        <div className="flex h-screen w-[50%] overflow-hidden relative">
            <img src="/register_page.jpg" lt="Gym" className="w-full h-full object-cover blur" />
        ...
        {/* Title */}
            ...
            <div className="flex flex-col items-center pt-[20px]">
                ...
                <div className="w-[400px] flex flex-col pt-[20px]">
                    ...
                    <input type="email" placeholder="Enter your password" className="w-[400px] h-[40px] border border-[#D4AF37] rounded-2xl bg-white px-5 outline-none focus:ring-2 focus:ring-[#D4AF37]"/></div>
                </div>

                <div className = "text-white text-center text-[20px] pt-[30px]">
                    <button className = " border border-[#D4AF37] border-[2px] w-[400px] h-[40px] rounded-2xl bg-[#D4AF37] hover:bg-[#333333] hover:outline-[#D4AF37] hover:text-black">Sign in</button>
                </div>

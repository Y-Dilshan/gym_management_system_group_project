        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {isLogged ? (
            ...
            <div className="hidden sm:flex gap-2 md:gap-3">
              <button onClick={() => navigate("/signin")} className="w-[150px] h-[35px] bg-[#050505] text-white text-[20px] items-center rounded border border-[#d4a017] hover:bg-[#d4a017] hover:text-black transition duration-300 cursor-pointer"> Sign in </button>
              <button onClick={() => navigate("/signup")} className="w-[150px] h-[35px] bg-[#d4a017] text-white text-[20px] items-center rounded hover:bg-[#050505] hover:text-white transition duration-300 cursor-pointer"> Sign Up </button>
            </div>
          )}
